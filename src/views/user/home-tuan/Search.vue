        ...
        <div class="content">
            ...
            <div class="option">
                ...
                <div class="byColor title-option">
                    ...
                    <ul>
                        <li>
                            <div class="icon-color red" id="red"></div><span>Đỏ</span>
                        </li>
                        <li>
                            <div class="icon-color black" id="black"></div><span>Đen</span>
                        </li>
                        <li>
                            <div class="icon-color silver" id="silver"></div><span>Bạc</span>
                        </li>
                        <li>
                            <div class="icon-color white" id="white"></div><span>Trắng</span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="list">
                ...
                <div class="sort">
                    <div class="positonSort">
                        ...
                        <ul class="values" v-if="hiddenValuesSort" v-on:click="selectValue">
                            <li v-for="itemSelect in valueSelect" :value="itemSelect.value" :key="itemSelect.value">
                                {{ itemSelect.text }}
                            </li>
                        </ul>
                    </div>
                ...
                <div class="listProduct">
                    <ul>
                        <li class="product" v-for="item in products" :key="item.id" @click="viewDetail(item)">
                            <div>
...
export default {
    ...
    methods: {
        ...
        getSlug() {
            this.slug = this.$route.params.query;
        ...
        async getData() {
            const response = await axios.get(
                "http://localhost:5000/product/search?query=" + this.slug
            );

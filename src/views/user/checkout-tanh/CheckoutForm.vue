...
export default {
  ...
  methods: {
    ...
    postCart() {
      ...
      // const response = axios.post("http://localhost:5000/cart", this.cart);
      ...
      axios
        .post("http://localhost:5000/cart", this.cart)
        .then(function(response) {
          ...
          axios
            .post("http://localhost:5000/cart-item", me2.listCartItem)
            .then(function(res) {
              console.log(res);
